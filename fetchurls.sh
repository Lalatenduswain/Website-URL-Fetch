...
footerInfo()
{
    ...
    echo "  https://github.com/Lalatenduswain/FetchURL"
    echo ""
    echo "Created by Lalatendu Swain"
    echo "  @lalatenduswain or https://www.lalatendu.info"
    echo ""
}
...
showHelp()
{
    ...
    if [ "$WGET_INSTALLED" -eq 0 ]; then
        ...
        echo "  For more information, run with the --wget flag, or check out https://github.com/Lalatenduswain/FetchURL#usage"
        echo ""
    fi
    echo "Usage:"
